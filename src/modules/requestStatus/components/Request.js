                ...
                return(
                    <tr className="request-wrapper border-2 hover:bg-color20 cursor-pointer">
                        <td className="flex py-4 pl-10">
                            <img className="w-11 h-11 rounded-full mr-5 object-cover" src={request.image} alt="img"/>
                            <div>
                                <p className="font-semibold text-sm text-color17 mb-1">{request.cashPurpose.toUpperCase()}</p>
