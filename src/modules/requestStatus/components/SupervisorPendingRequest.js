...
function SupervisorPendingRequest({handleLoader, handleClick}) {
            ...
            <div className="w-full px-7">
                ...
                <table className="w-full rounded-full border border-t-0 border-color16">
                    ...
                    </tr>
                    {
                        ...
                        :
                    <SupervisorRequestTemplate requestData={allPendingRequest} handleClick={handleClick} clickStatus={true}/>
                    }
                </table>
...
export default SupervisorPendingRequest;
