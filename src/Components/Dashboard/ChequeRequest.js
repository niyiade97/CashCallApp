            ...
            <div className="w-11/12 m-auto">
                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-45 m-auto py-3">
                        <input type="submit" value="submit" className=" border w-full bg-color2 text-white h-14 rounded-full mx-2 text-lg font-semibold hover:border-color2 hover:bg-white hover:text-color2" />
                    </div>
                </div>
