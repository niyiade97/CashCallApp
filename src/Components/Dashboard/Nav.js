...
function Nav({path, text, icon, dropDownIsActive, handleClick}) {
    ...
    return (
        <Link to={path} className="nav-container flex justify-start items-center text-color5 my-8 hover:text-color2 group focus:text-color2" onClick={dropDownIsActive ? handleOnClick : ""}>
