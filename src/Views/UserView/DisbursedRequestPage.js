...
import UserDisbursedRequest from "../../modules/requestStatus/components/UserDisbursedRequest";
    ...
    return (
        ...
        }
        {
            ...
            <div className="w-full flex">
                <UserDisbursedRequest handleClick={handleClick} handleLoader={handleLoader}/>
            </div>
        </UserDashboardContainer>
    )
}
