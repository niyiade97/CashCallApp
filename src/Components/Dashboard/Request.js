                    ...
                    <tr className="border-1.5 hover:bg-color20 cursor-pointer">
                        ...
                        <td className="py-4">
                            <div className="flex items-center justify-between pr-14">
                                <button className={`rounded-full ${request.status === "0" && "bg-red-600"} ${request.status === "1" && "bg-color10" } ${request.status === "2" && "bg-color9"} text-white text-xs font-bold py-1 px-3`}>Accepted</button>
