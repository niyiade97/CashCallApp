        ...
        <div className="w-11/12 rounded-3xl border-color7 border mb-8 mx-auto py-4 mt-5 shadow-transactionBoxShadow"> 
            <div className="w-11/12 m-auto">
                ...
                <div className="flex flex-wrap">
                    ...
                    <TextField type="text" name="beneficiaryName" placeholder="Adejumo Adeniyi" label="Beneficiary’’s Name" onChange={handleOnChange} disabled={false} width="2/4"  />
                    <Select name="beneficiaryBank" placeholder="GTB" label="Beneficiary’’s Bank" onChange={handleOnChange} disabled={false} options={["GTB","FCMB","UNITY"]} width="2/4" />
